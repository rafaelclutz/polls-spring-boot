package br.com.lutztech.polls.service;
...
import br.com.lutztech.polls.exception.BadRequestException;
import br.com.lutztech.polls.exception.ResourceNotFoundException;
import br.com.lutztech.polls.model.Choice;
...
import br.com.lutztech.polls.util.ModelMapper;
...
public class PollService {
    ...
    public ApiResponse deletePollById(Long pollId) {
    	Poll poll = pollRepository.findById(pollId).orElseThrow(
                () -> new ResourceNotFoundException("Poll", "id", pollId));
    	
    	pollRepository.delete(poll);
    	
    	return new ApiResponse(true, "Poll deleted!");
    }
